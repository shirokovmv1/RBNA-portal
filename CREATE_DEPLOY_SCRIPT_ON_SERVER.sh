...
# Выполните эту команду на сервере, чтобы создать deploy_to_151.245.137.147.sh

cat > /root/deploy_to_151.245.137.147.sh << 'DEPLOYSCRIPT'
#!/bin/bash
...
echo "✅ Скрипт создан: /root/deploy_to_151.245.137.147.sh"
echo ""
echo "Теперь запустите:"
echo "  /root/deploy_to_151.245.137.147.sh"
